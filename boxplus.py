...
class _Main:
    def main(self):
        ...
        Application(self.root).mainloop()

    def __init__(self):
        self.root = tk.Tk()
        icons = 'tmp.ico'
        hover_text = "my box plus"  # 悬浮于图标上方时的提示
        menu_options = (('一级菜单', None, self.switch_icon),
                        ('二级菜单', None, (('哇哈哈', None, self.switch_icon),)))
    ...
    @staticmethod
    def switch_icon(self, _sys_tray_icon, icons='tmp.ico'):
