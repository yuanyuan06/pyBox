    ...
    def __init__(self):
        ...
        for bdw in range(5):
            ...
            for relief in [RAISED, SUNKEN, FLAT, RIDGE, GROOVE, SOLID]:
                ...
                Button(getattr(self, 'of%d' % bdw), text=relief, borderwidth=bdw, relief=relief, width=10,
                       command=lambda s=self, r=relief, b=bdw: s.prt(r,b)).pack(side=LEFT, padx=7-bdw, pady=7-bdw)
